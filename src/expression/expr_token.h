...
enum etoken_type {
    ...
    TOK_VLITERAL        = 0x00000002,    /* Vector literal */
    TOK_NEGATE          = 0x00000004,
    TOK_FN              = 0x00000008,    /* Function */
    TOK_FN_DOT          = 0x00000010,    /* Dot function */
    TOK_VFN             = 0x00000020,    /* Vector function */
