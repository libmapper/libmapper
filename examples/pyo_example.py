...
try:
    ...
    dev.add_signal(mapper.DIR_INCOMING, 1, "frequency", 1, 'f', "Hz", 0, 1000, lambda s,i,n,t: freq.setValue(n))
    dev.add_signal(mapper.DIR_INCOMING, 1, "amplitude", 1, 'f', "normalized", 0, 1, lambda s,i,n,t: amp.setValue(n))
    dev.add_signal(mapper.DIR_INCOMING, 1, "duty", 1, 'f', "normalized", 0, 1, lambda s,i,n,t: duty.setValue(n))
