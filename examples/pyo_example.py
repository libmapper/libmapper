...
try:
    ...
    dev.add_input("/frequency", 1, 'f', "Hz", 0, 1000, lambda s, n: freq.setValue(n))
    dev.add_input("/amplitude", 1, 'f', "normalized", 0, 1, lambda s, n: amp.setValue(n))
    dev.add_input("/duty", 1, 'f', "normalized", 0, 1, lambda s, n: duty.setValue(n))
