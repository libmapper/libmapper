...
int main()
{
    ...
    dev.add_sig(MPR_DIR_IN, "/freq", 1, 'f', "Hz", &min0, &max1000, NULL,
                handler_freq, MPR_SIG_UPDATE);
    dev.add_sig(MPR_DIR_IN, "/gain", 1, 'f', "Hz", &min0, &max1, NULL,
                handler_gain, MPR_SIG_UPDATE);
    dev.add_sig(MPR_DIR_IN, "/duty", 1, 'f', "Hz", &min0, &max1, NULL,
