...
void loop()
{
    ...
    if (!done && autoconnect) {
        ...
        mmon_update_map(mon, mapper_map_new(1, &src, &recvsig_1->props));
        src = &sendsig_2->props;
        mmon_update_map(mon, mapper_map_new(1, &src, &recvsig_2->props));
        src = &sendsig_3->props;
        mmon_update_map(mon, mapper_map_new(1, &src, &recvsig_3->props));
        src = &sendsig_3->props;
        mmon_update_map(mon, mapper_map_new(1, &src, &recvsig_4->props));
