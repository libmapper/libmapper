...
void loop()
{
    ...
    if (!done && autoconnect) {
        ...
        mmon_update_map(mon, mmon_add_map(mon, 1, &src, &recvsig_1->props));
        src = &sendsig_2->props;
        mmon_update_map(mon, mmon_add_map(mon, 1, &src, &recvsig_2->props));
        src = &sendsig_3->props;
        mmon_update_map(mon, mmon_add_map(mon, 1, &src, &recvsig_3->props));
        src = &sendsig_3->props;
        mmon_update_map(mon, mmon_add_map(mon, 1, &src, &recvsig_4->props));
