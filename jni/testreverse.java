...
class testreverse {
    public static void main(String [] args) {
        ...
        Signal input = dev.addSignal(Direction.INCOMING, "insig", 1, Type.FLOAT,
        ...
        Signal output = dev.addSignal(Direction.OUTGOING, "outsig", 1, Type.INT32,
                                      "Hz", null, null, null, new Listener() {
        ...
        while (i >= 0) {
            ...
            if (i == 50) {
                ...
                output.properties().put(Property.DIRECTION, Direction.INCOMING);
                output.push();
            }
        }
        dev.free();
