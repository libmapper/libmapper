  ...
  (JNIEnv *env, jobject obj, jlong p, jobject src, jobject dest, jobject props)
{
    ...
    if (!srcdev || !destdev)
        return;
    // TODO: process props!
    mapper_monitor_link(mon, mdev_properties(srcdev), mdev_properties(destdev), 0, 0);
}
  ...
  (JNIEnv *env, jobject obj, jlong p, jobject src, jobject dest, jobject props)
{
    ...
    if (!srcdev || !destdev)
        return;
    // TODO: process props!
    mapper_monitor_link(mon, srcdev, destdev, 0, 0);
}
  ...
  (JNIEnv *env, jobject obj, jlong p, jobject src, jobject dest)
{
    ...
    if (!srcdev || !destdev)
        return;
    mapper_monitor_unlink(mon, mdev_properties(srcdev), mdev_properties(destdev));
}
  ...
  (JNIEnv *env, jobject obj, jlong p, jobject src, jobject dest)
{
    ...
    if (!srcdev || !destdev)
        return;
    mapper_monitor_unlink(mon, srcdev, destdev);
}
  ...
  (JNIEnv *env, jobject obj, jlong p, jobject src, jobject dest)
{
    ...
    if (!srcsig || !destsig)
        return;
    mapper_monitor_disconnect(mon, srcsig, destsig);
}
